...
gw.innogrid.com(더존 그룹웨어)의 출근/퇴근 버튼을 화면 상단 헤더의
`noti-details` 아래에 고정 배치해, 스크롤 없이 바로 누를 수 있게 하는 크롬 확장입니다.
...
5. https://gw.innogrid.com 에 접속하면 헤더 `noti-details` 아래에 출근/퇴근 버튼이 나타난다.
...
│   ├── injectButtons.ts   noti-details 아래에 버튼 생성/주입
