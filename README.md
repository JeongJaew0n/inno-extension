...
현재 배포 버전은 [v0.7.0](https://github.com/JeongJaew0n/inno-extension/releases/tag/v0.7.0)이며, 배포 ZIP은 릴리즈 페이지에서 받을 수 있다.
...
현재 릴리즈: [Inno Extension v0.7.0](https://github.com/JeongJaew0n/inno-extension/releases/tag/v0.7.0)
