...
현재 배포 버전은 [v0.9.0](https://github.com/JeongJaew0n/inno-extension/releases/tag/v0.9.0)이며, 배포 ZIP은 릴리즈 페이지에서 받을 수 있다.
...
- Popup의 기능 상세에서 태그별 표시를 켜고 끄거나, 직접 추가·수정·삭제한다. **기본 제공 태그는 숨길 수만 있고 삭제할 수 없다.**
...
현재 릴리즈: [Inno Extension v0.9.0](https://github.com/JeongJaew0n/inno-extension/releases/tag/v0.9.0)
